...
const summarizeTool = {
	...
	inputSchema: z.object({
		maxPoints: z
			.number()
			.optional()
			.describe("Maximum number of key points"),
...
const Example = () => (
	<Agent>
		...
		<AgentContent>
			<AgentInstructions>
				You are a helpful research assistant. Your job is to search the
				web for information and summarize findings for the user. Always
				cite your sources and provide accurate, up-to-date information.
			</AgentInstructions>
