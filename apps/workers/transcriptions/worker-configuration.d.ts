/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 11d848ed70f1bbf74186df06311e8bad)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		AI: Ai;
		TRANSCRIPTIONS_CALLBACK_ENDPOINT: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TRANSCRIPTIONS_CALLBACK_ENDPOINT">> {}
}
